import {fetchHomePageFromSanity} from './sanity-home.js'
...
export default async function handler(req: any, res: any) {
  ...
  try {
    const homePage = await fetchHomePageFromSanity({
    ...
    const message = error instanceof Error ? error.message : 'Unable to load home content from Sanity.'
